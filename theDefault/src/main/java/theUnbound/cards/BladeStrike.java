...
public class BladeStrike extends CustomCard {
    ...
    public static final String ID = DefaultMod.makeID(BladeStrike.class.getSimpleName());
    ...
    public BladeStrike() {
        ...
        this.tags.add(UnboundTags.FIRE);
    }
