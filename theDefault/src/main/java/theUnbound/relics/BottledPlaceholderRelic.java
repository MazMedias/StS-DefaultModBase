...
import theUnbound.patches.relics.BottledPlaceholderField;
import theUnbound.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static theUnbound.DefaultMod.makeRelicOutlinePath;
import static theUnbound.DefaultMod.makeRelicPath;
